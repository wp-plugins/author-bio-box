...
Plugin URI: http://wordpress.org/extend/plugins/author-bio-box/
...
function authorbbio_add_facebook() {
    ...
    if($authorbbio_facebook == "" || $authorbbio_facebook == null) {
        ...
        return "<a href=\"$authorbbio_facebook\"><img src=\"$authorbbio_plugin_url\" alt=\"facebook\" /></a>";
    }
}
...
function authorbbio_add_twitter() {
    ...
    if($authorbbio_twitter == "" || $authorbbio_twitter == null) {
        ...
        return "<a href=\"$authorbbio_twitter\"><img src=\"$authorbbio_plugin_url\" alt=\"twitter\" /></a>";
    }
}
...
function authorbbio_add_googleplus() {
    ...
    if($authorbbio_googleplus == "" || $authorbbio_googleplus == null) {
        ...
        return "<a href=\"$authorbbio_googleplus\"><img src=\"$authorbbio_plugin_url\" alt=\"google plus\" /></a>";
    }
}
...
<div id=\"blog-autor\">
    <div id=\"autor-bio\">
        ...
        <p id=\"autor-desc\">$authorbbio_desc</p>
...
add_filter('the_content', 'authorbbio_add_box');
?>